// PRJ: normally we return and Unchecked_Array_Index which meets the criteria below I believe and for the right reasons.
// Adding quick len check here to test.
